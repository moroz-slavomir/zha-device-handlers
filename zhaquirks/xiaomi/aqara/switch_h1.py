"""Xiaomi aqara EU H1 wall switch devices."""
import logging
...
class AqaraSwitchH1NoNeutralBase(XiaomiCustomDevice):
...
class AqaraSwitchH1NoNeutral_2G(AqaraSwitchH1NoNeutralBase):
...
class AqaraSwitchH1NoNeutral_1G(AqaraSwitchH1NoNeutralBase):
    """Aqara double key switch device."""
